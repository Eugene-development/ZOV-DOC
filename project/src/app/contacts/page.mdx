...
Информация для связи с ответственными лицами. {{ className: 'lead' }}


### Телефоны

<Properties>
  <Property name="Иванов Иван Иванович" type="Директор">
    тел. 8-777-777-77-77
  </Property>
  <Property name="Иванов Иван Иванович" type="Управляющий">
    тел. 8-777-777-77-77
  </Property>
</Properties>
...
## 8-777-777-77-77 {{ tag: 'Каменная политра', label: 'Столешницы' }}

<Row>
  <Col>

    Для решения вопросов по решению вопросов.

    ### Optional attributes

    <Properties>
      <Property name="Мария" type="менеджер">
        Вопросы по ценам.
      </Property>
    </Properties>
